...
export const AddAndSelectUserModal = (props: Props) => {
	...
	const isValid = (): boolean => {
		...
		const hasEmptyName = !!users.find((user: User) => user.name.trim().length === 0);
		return !hasEmptyName;
	}
	...
	return (
		<Dialog onClose={()=>{}}
				...
				maxWidth="lg"
				fullWidth={false}>
			<div style={{width: 1000, paddingLeft: 20, paddingRight: 20, paddingBottom: 30}}>
